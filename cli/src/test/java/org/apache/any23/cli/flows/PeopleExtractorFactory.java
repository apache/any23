...
public class PeopleExtractorFactory extends SimpleExtractorFactory<PeopleExtractor>
    ...
    private static final ExtractorDescription descriptionInstance = new PeopleExtractorFactory();

    public PeopleExtractorFactory() {
        super(NAME, prefixes, Arrays.asList("*/*"), null);
    }

    @Override
    public PeopleExtractor createExtractor() {
