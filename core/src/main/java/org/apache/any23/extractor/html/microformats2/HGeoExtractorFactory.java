 ...
 *
 */
public class HGeoExtractorFactory extends SimpleExtractorFactory<HGeoExtractor>
        implements ExtractorFactory<HGeoExtractor> {
    ...
    public HGeoExtractorFactory() {
        super(HGeoExtractorFactory.NAME, HGeoExtractorFactory.PREFIXES,
                Arrays.asList("text/html;q=0.1", "application/xhtml+xml;q=0.1"), "example-mf2-h-geo.html");
    }
