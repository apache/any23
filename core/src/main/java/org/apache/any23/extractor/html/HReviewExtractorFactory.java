 ...
 *
 */
public class HReviewExtractorFactory extends SimpleExtractorFactory<HReviewExtractor>
        implements ExtractorFactory<HReviewExtractor> {
    ...
    public HReviewExtractorFactory() {
        super(HReviewExtractorFactory.NAME, HReviewExtractorFactory.PREFIXES,
                Arrays.asList("text/html;q=0.1", "application/xhtml+xml;q=0.1"), "example-mf-hreview.html");
    }
