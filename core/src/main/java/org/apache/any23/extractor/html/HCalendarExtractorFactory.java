 ...
 *
 */
public class HCalendarExtractorFactory extends SimpleExtractorFactory<HCalendarExtractor>
        implements ExtractorFactory<HCalendarExtractor> {
    ...
    public HCalendarExtractorFactory() {
        super(HCalendarExtractorFactory.NAME, HCalendarExtractorFactory.PREFIXES,
                Arrays.asList("text/html;q=0.1", "application/xhtml+xml;q=0.1"), "example-mf-hcalendar.html");
    }
